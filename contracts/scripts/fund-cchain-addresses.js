...
const main = async () => {
	...
	// console.log(avaxAssetID);
	// const avax = await utils_1.Defaults.network['12345'].X.avaxAssetID;
	// console.log(avax);
	// console.log(bintools.cb58Encode(avaxAssetID))
	...
	console.log(getBalanceResponse.balance)
